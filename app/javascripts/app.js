...
import WIMToken_artifacts from '../../build/contracts/WIMToken.json'
import teamallocation_artifacts from '../../build/contracts/TeamAllocation.json'

// WIMToken is our usable abstraction, which we'll use through the code below.
var WIMToken = contract(WIMToken_artifacts);
...
window.App = {
  start: function() {
    ...
    // Bootstrap the WIMToken abstraction for Use.
    WIMToken.setProvider(web3.currentProvider);
    ...
    web3.eth.getAccounts(function(err, accs) {
      ...
      WIMToken.deployed().then(function(instance) {
  ...
  purchaseTokenFor: function(index) {
    ...
    var meta;
    WIMToken.at(contract_address).then(function(instance) {
      meta = instance;
  ...
  purchaseToken: function() {
    ...
    var meta = WIMToken.at("0xd908885691fb0af3742fac847e9733f0c9901f7d");
  ...
  refund: function() {
    var wim = WIMToken.at("0x0c7ac04c92e217cf404b6a105a89ad8730ae06a6");
    //console.log(wim);
    return wim.refund({from: "0x65a5A157F5097b5820A8f742f4432344f9dC94E7"}).then(function(result){
      console.log(result);
    }).catch(function (e) {
      console.log(e);
    });
  ...
  allocateForRefund: function() {
    var wim = WIMToken.at("0x0c7ac04c92e217cf404b6a105a89ad8730ae06a6");
    return wim.allocateForRefund({from: "0xFa30C312999731297236302B1cE272675223EBF8", value: web3.toWei('1.5','ether')}).then(function(result) {
      console.log(result);
    }).catch(function(e) {
      console.log(e);
    });
...
window.addEventListener('load', function() {
  ...
  if (typeof web3 !== 'undefined') {
    console.warn("Using web3 detected from external source. If you find that your accounts don't appear or you have 0 WIMToken, ensure you've configured that source properly. If using MetaMask, see the following link. Feel free to delete this warning. :) http://truffleframework.com/tutorials/truffle-and-metamask")
